  ...
  <nav class="fixed top-0 left-0 right-0 bg-white border-b border-gray-300 z-50">
    <div class="container mx-auto px-4 flex items-center justify-between ">
      ...
      <div :class="{ 'block': menuOpen, 'hidden': !menuOpen }"
        class="md:flex space-x-8 md:space-x-12 md:items-center w-full md:w-auto mt-4 md:mt-0">
        <!-- Links with Right Border -->
        <div class="md:border-r-2 md:h-full border-[#DFDFE1] flex flex-col md:flex-row md:space-x-8 w-full">
          <a href="#" class="text-gray-800 hover:text-red-700 font-medium"
            :class="{
        ...
        <div class="hidden md:block text-red-600 font-medium opacity-50 text-sm md:text-base hover:opacity-100 whitespace-nowrap">
          +1 668 54871 345
        </div>
      </div>
    </div>
